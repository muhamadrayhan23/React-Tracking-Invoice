...
const EditQuotation = () => {
        ...
        const fetchData = async () => {
            try {
                ...
                setForm({
                    ...
                    estimate_date: quotationData.quotation.estimate_date.split("T")[0],
                    expiry_date: quotationData.quotation.expiry_date.split("T")[0],
                    project_title: quotationData.quotation.project_title,
                    start_date: quotationData.quotation.start_date.split("T")[0],
                    deadline: quotationData.quotation.deadline.split("T")[0],
                ...
                // Calculate subtotal for discount reverse calculation
                const loadedSubtotal = quotationData.items.reduce(
                ...
                setQuotationTerms(quotationData.terms.map(t => ({
                    ...
                    nominal: t.nominal,
                    term_estimate: t.term_estimate?.split("T")[0] || "",
                    term_percentage: t.term_percentage,
                })));
                ...
                setForm({
                    ...
                    start_date: quotationData.quotation.start_date.split("T")[0],
                    deadline: quotationData.quotation.deadline.split("T")[0],
                    discount: loadedSubtotal > 0 ? (quotationData.quotation.discount / loadedSubtotal) * 100 : 0,
                    discount_type: "percent",
                });
            } catch (err) {
                console.error(err);
    ...
    const addLine = () => {
        setQuotationItems(prev => [
            ...prev,
            { item_id: "", description: "", qty: 1, price: 0, tax_id: "", tax_rate: 0 },
        ]);
    };
    ...
    const updateItem = (index, field, value) => {
        setQuotationItems(prev => {
            ...
            if (field === "tax_id") {
                ...
                updated[index].tax_rate = tax ? tax.rate : 0;
            }
            return updated;
        });
    };
